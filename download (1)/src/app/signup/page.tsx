...
import { User, LogIn, Mail, Phone, Lock } from 'lucide-react';

// Inlined AuthForm for Signup
const signupSchema = z.object({
  firstName: z.string().min(1, { message: "First name is required." }),
  lastName: z.string().min(1, { message: "Last name is required." }),
  email: z.string().email({ message: "Invalid email address." }),
  password: z.string().min(6, { message: "Password must be at least 6 characters." }),
  phoneNumber: z.string().regex(/^04\d{8}$/, { message: "Must be a 10-digit number starting with 04." }),
});
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type="tel" placeholder="0412 345 678" {...field} className="pl-10" />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
